...
def webhook():
    ...
    message_processors = [
        (
            message_validators.is_add_mem_group_command(vk_response),
            message_handlers.add_mem_group_handler()
        ),
        (
            message_validators.is_delete_mem_group_command(vk_response),
            message_handlers.delete_mem_group_handler()
        ),
        (
            message_validators.is_post_memes_command(vk_response),
            message_handlers.post_memes_handler()
        ),
        (
            message_validators.is_post_memes_from_command(vk_response),
            message_handlers.post_memes_from_handler()
        ),
        (
            message_validators.is_add_news_group_command(vk_response),
            message_handlers.add_mem_group_handler()
        ),
        (
            message_validators.is_delete_news_group_command(vk_response),
            message_handlers.delete_news_group_handler()
        ),
        (
            message_validators.is_post_news_command(vk_response),
            message_handlers.post_news_handler()
        ),
        (
            message_validators.is_post_news_from_command(vk_response),
            message_handlers.post_news_from_handler()
        ),
        (
            message_validators.is_parse_possible_photos_command(vk_response),
            message_handlers.parse_possible_photos_handler()
        ),
        (
            message_validators.is_imitate_newsfeed_command(vk_response),
            message_handlers.imitate_newsfeed_handler()
        ),
        (
            message_validators.is_parse_hidden_info_command(vk_response),
